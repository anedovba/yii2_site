...
function initialize() {
  var mapOptions = {
    zoom: 13,
    center: new google.maps.LatLng(50.446467, 30.521393)
};
...
var contentString = '<div class="info-box"><img src="img/estate/img-3.jpg" style="max-width:100%; margin-bottom:10px;" alt="" /><h4><?= Yii::t(\'app\', \'Адрес\')?></h4><p><?= Yii::t(\'app\', \'Описание\')?></p><a href="r-property-detail.php" class="btn btn-red"><?= Yii::t(\'app\', \'Посмотреть детали\')?></a><br/></div>';
